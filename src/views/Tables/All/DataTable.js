...
//        console.log(x);
 ...
 getBase64(url) {
  ...
  completeButton(cell, row){
    return (<div style={{textAlign:"center"}}> <Button style={{padding:'3px'}}  color="success" onClick={() => this.markDone(row.id)}>Complete</Button></div>)

  }

  backButton(cell, row){
    return (<div style={{textAlign:"center"}}> <Button style={{padding:'3px'}} color="success" onClick={() => this.sendBack(row.id)}>Send Back</Button></div>)
  }
  doneButton(cell, row){
     return (<div style={{textAlign:"center"}}><Button onClick={() => {this.getReport(row)}} color="danger">Report</Button></div>)
  }
  goButton(cell, row){
